...
using inventory_service.Core.Application.UseCases;
using inventory_service.Infrastructure.Data.EventStore;
using inventory_service.Infrastructure.Messaging;
using inventory_service.Infrastructure.Models;

var builder = WebApplication.CreateBuilder(args);
builder.Services.AddControllers();
builder.Services.AddSingleton<IPropertyUseCase, PropertyUseCase>();
