    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-4">PropertyBooker</h3>
            <p className="text-gray-300">
              Find and book your perfect stay with our easy-to-use platform.
              The best prices, the widest selection of properties.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition">Properties</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition">Safety Information</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition">Cancellation Options</a></li>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300">
              ...
              <p className="mt-2">Email: info@propertybooker.com</p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">
            © {new Date().getFullYear()} PropertyBooker. All rights reserved.
          </p>
